...
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.BEFORE_SELECTION_CHANGE;
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.BLUR;
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.CHANGE;
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.CURSOR_ACTIVITY;
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.FOCUS;
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.GUTTER_CLICK;
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.SCROLL;
import static com.codenvy.ide.editor.codemirrorjso.client.EventTypes.VIEWPORT_CHANGE;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.AUTOCLOSE_BRACKETS;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.AUTOCLOSE_TAGS;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.FOLD_GUTTER;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.KEYMAP;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.MATCH_BRACKETS;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.READONLY;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.SHOW_CURSOR_WHEN_SELECTING;
import static com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey.STYLE_ACTIVE_LINE;
...
import com.codenvy.ide.editor.codemirrorjso.client.CMRangeOverlay;
...
import com.codenvy.ide.editor.codemirrorjso.client.marks.CMTextMarkerOptionOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.marks.CMTextMarkerOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.options.CMEditorOptionsOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.options.CMMatchTagsConfig;
import com.codenvy.ide.editor.codemirrorjso.client.options.OptionKey;
