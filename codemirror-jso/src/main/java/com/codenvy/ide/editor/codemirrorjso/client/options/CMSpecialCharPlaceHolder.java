 ...
 *******************************************************************************/
package com.codenvy.ide.editor.codemirrorjso.client.options;
...
public class CMSpecialCharPlaceHolder extends JavaScriptObject {
    ...
    public static final native CMSpecialCharPlaceHolder create(SpecialCharPlaceHolder placeHolder) /*-{
        return function(specialChar) {
            return placeHolder.@com.codenvy.ide.editor.codemirror.client.jso.options.CMSpecialCharPlaceHolder.SpecialCharPlaceHolder::createPlaceHolder(C)(specialChar);
        }
    }-*/;
