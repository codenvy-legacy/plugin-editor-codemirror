...
import com.codenvy.ide.editor.codemirrorjso.client.EventHandlers.EventHandlerNoParameters;
import com.codenvy.ide.editor.codemirrorjso.client.EventHandlers.EventHandlerOneParameter;
import com.codenvy.ide.editor.codemirrorjso.client.dialog.CMDialogOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.hints.CMHintOptionsOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.line.CMLineHandleOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.line.CMLineInfoOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.line.CMLineWidgetOptionOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.line.CMLineWidgetOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.marks.MarksManager;
import com.codenvy.ide.editor.codemirrorjso.client.parse.CMTokenOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.scroll.CMPixelRangeOverlay;
import com.codenvy.ide.editor.codemirrorjso.client.scroll.CMScrollInfoOverlay;
        ...
        this
                .on(
                        ...
                        function() {
                            ...
                            handler.@com.codenvy.ide.editor.codemirrorjso.client.CMEditorOverlay.EventHandlerMultipleParameters::onEvent(*)(params);
                        });
    }-*/;
    ...
    public final native void on(String eventType, EventHandlerNoParameters handler) /*-{
        this
                .on(
                        eventType,
                        function() {
                            handler.@com.codenvy.ide.editor.codemirrorjso.client.EventHandlers.EventHandlerNoParameters::onEvent()();
                        });
    }-*/;
    ...
    public final native <T extends JavaScriptObject> void on(String eventType, EventHandlerOneParameter<T> handler) /*-{
        this
                .on(
                        eventType,
                        function(param) {
                            handler.@com.codenvy.ide.editor.codemirrorjso.client.EventHandlers.EventHandlerOneParameter::onEvent(*)(param);
                        });
    }-*/;
        ...
        this
                .on(
                        ...
                        function() {
                            ...
                            handler.@com.codenvy.ide.editor.codemirrorjso.client.EventHandlers.EventHandlerMixedParameters::onEvent(*)(params);
                        });
    }-*/;

    /** @deprecated use {@link EventHandlers.EventHandlerMultipleParameters} with
     * {@link CodeMirrorOverlay#on(JavaScriptObject, String, com.codenvy.ide.editor.codemirrorjso.client.EventHandlers.EventHandlerMultipleParameters)} */
    @Deprecated
