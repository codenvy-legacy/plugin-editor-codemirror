 ...
 *******************************************************************************/
package com.codenvy.ide.editor.codemirrorjso.client.dialog;
...
public class CMConfirmCallbackOverlay extends JavaScriptObject {
    ...
    public static final native CMConfirmCallbackOverlay create(ConfirmCallback callback) /*-{
        return function(editor) {
            callback.@com.codenvy.ide.editor.codemirrorjso.client.dialog.CMConfirmCallbackOverlay.ConfirmCallback::onConfirm(*)(editor);
        };
    }-*/;
