...
public class CMDocumentOverlay extends JavaScriptObject {
    ...
    public final native void eachline(LineOperation lineOperation) /*-{
        this.eachLine(
            lineOperation.@com.codenvy.ide.editor.codemirrorjso.client.CMDocumentOverlay.LineOperation::processLine(Lcom/codenvy/ide/editor/codemirrorjso/client/line/CMLineHandleOverlay;)
        );
    }-*/;
