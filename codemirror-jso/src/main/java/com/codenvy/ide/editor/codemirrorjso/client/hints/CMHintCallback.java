...
public class CMHintCallback extends JavaScriptObject {
    ...
    public static final native CMHintCallback create(HintCallbackFunction callbackFun) /*-{
        return $entry(function(data) {
            callbackFun.@com.codenvy.ide.editor.codemirrorjso.client.hints.CMHintCallback.HintCallbackFunction::callback(Lcom/codenvy/ide/editor/codemirrorjso/client/hints/CMHintResultsOverlay;)(data);
        });
    }-*/;
